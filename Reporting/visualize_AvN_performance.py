...
files_ctrl = ['HTML reports/191105/intermDataAvNCtrl_fAE_20191104_30-01.csv'] #['data/October/intermDataAvNCtrl_fAE_20191020.csv']
...
range_influent = [20, 60]#[10, 50]
range_effluent = [0.5, 2]#[0, 20]
range_AvN = [0, 2]
...
df_avg_DO = calc_average(df['Pilote reactor 4 DO'],1)
df = df.join(df_avg_DO, how='outer')
